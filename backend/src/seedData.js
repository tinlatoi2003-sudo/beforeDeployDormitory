...
const roomsData = [
  {
    ...
    maxOccupancy: 4,
    currentOccupancy: 2,
    pricePerTerm: 3600000,
    status: "partial",
    amenities: ["wifi", "fan", "hot_water"],
    description: "Phong 4 giuong, tang 1",
    isActive: true,
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-02-01T08:00:00.000Z"),
  },
  ...
  },
  {
    ...
    maxOccupancy: 2,
    currentOccupancy: 0,
    pricePerTerm: 5400000,
    status: "available",
    amenities: ["wifi", "air_con", "hot_water"],
    description: "Phong VIP 2 giuong, co dieu hoa, tang 2",
    isActive: true,
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
  {
    ...
    status: "partial",
    amenities: ["wifi", "fan", "hot_water"],
    description: "Phong 4 giuong nu, tang 1",
    isActive: true,
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-02-01T08:00:00.000Z"),
  },
  {
    ...
    status: "full",
    amenities: ["wifi", "fan", "hot_water"],
    description: "Phong 4 giuong nu, tang 1 - DAY",
    isActive: true,
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
  ...
  },
  {
    ...
    status: "available",
    amenities: ["wifi", "air_con", "hot_water"],
    description: "Phong VIP 2 giuong nu, co dieu hoa, tang 2",
    isActive: true,
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
...
const roomAssignmentsData = [
  ...
  },
  {
    ...
    studentId: id("665b1b2c3d4e5f6a7b8c9d04"),
  ...
  },
  {
    ...
    studentId: id("665b1b2c3d4e5f6a7b8c9d01"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d03"),
    buildingId: id("665c1b2c3d4e5f6a7b8c9d01"),
    termCode: "2024-HK2",
    ...
    updatedAt: new Date("2025-01-31T08:00:00.000Z"),
  },
];
...
const roomRegistrationsData = [
  {
    ...
    updatedAt: new Date("2025-01-20T14:00:00.000Z"),
  },
  {
    _id: id("665f1b2c3d4e5f6a7b8c9d02"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d05"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d03"),
    termCode: "2025-HK1",
    status: "pending",
...
const requestsData = [
  {
    ...
    studentId: id("665b1b2c3d4e5f6a7b8c9d01"),
    type: "damage_report",
    title: "Quat tran phong A101 bi hong",
    ...
    managerReview: {
      reviewedBy: id("665a1b2c3d4e5f6a7b8c9d02"),
      status: "approved",
      note: "Da kiem tra, quat hong motor.",
      reviewedAt: new Date("2025-02-16T10:00:00.000Z"),
    },
    adminReview: null,
    createdAt: new Date("2025-02-15T08:00:00.000Z"),
    updatedAt: new Date("2025-02-16T10:00:00.000Z"),
  },
  {
    _id: id("66601b2c3d4e5f6a7b8c9d02"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d03"),
    type: "room_transfer",
    title: "Xin chuyen tu phong A102 sang A201",
    ...
    managerReview: null,
    adminReview: null,
    createdAt: new Date("2025-02-18T14:00:00.000Z"),
    updatedAt: new Date("2025-02-18T14:00:00.000Z"),
  },
  {
    _id: id("66601b2c3d4e5f6a7b8c9d03"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d02"),
    type: "room_retention",
    title: "Xin giu phong A101 ky tiep theo",
    ...
    managerReview: null,
    adminReview: null,
    createdAt: new Date("2025-02-25T09:00:00.000Z"),
    updatedAt: new Date("2025-02-25T09:00:00.000Z"),
  },
];
...
const reportsData = [
  {
    ...
    status: "pending",
    adminReview: null,
    createdAt: new Date("2025-02-28T15:00:00.000Z"),
    updatedAt: new Date("2025-02-28T15:00:00.000Z"),
  },
  {
    ...
    createdAt: new Date("2025-02-20T11:00:00.000Z"),
    updatedAt: new Date("2025-02-22T09:00:00.000Z"),
  },
];
...
const invoicesData = [
  {
    _id: id("66621b2c3d4e5f6a7b8c9d01"),
    invoiceCode: "INV-2025-0001",
    studentId: id("665b1b2c3d4e5f6a7b8c9d01"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d01"),
    type: "room_fee",
    termCode: "2025-HK1",
    description: "Tien phong A101 - HK1/2025",
    amount: 3600000,
    paidAmount: 3600000,
    ...
    updatedAt: new Date("2025-02-10T14:30:00.000Z"),
  },
  {
    _id: id("66621b2c3d4e5f6a7b8c9d02"),
  ...
  {
    _id: id("66621b2c3d4e5f6a7b8c9d03"),
    invoiceCode: "INV-2025-0003",
    studentId: id("665b1b2c3d4e5f6a7b8c9d03"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d02"),
    type: "room_fee",
    termCode: "2025-HK1",
    description: "Tien phong A102 - HK1/2025",
    amount: 3600000,
    paidAmount: 1800000,
    dueDate: new Date("2025-02-28T23:59:59.000Z"),
    status: "partial",
  ...
  {
    _id: id("66621b2c3d4e5f6a7b8c9d04"),
    invoiceCode: "INV-2025-0004",
    studentId: id("665b1b2c3d4e5f6a7b8c9d04"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d04"),
    type: "room_fee",
    termCode: "2025-HK1",
    description: "Tien phong B101 - HK1/2025",
    amount: 3600000,
    paidAmount: 3600000,
    dueDate: new Date("2025-02-28T23:59:59.000Z"),
    status: "paid",
  ...
  {
    _id: id("66621b2c3d4e5f6a7b8c9d05"),
    invoiceCode: "INV-2025-0005",
    studentId: id("665b1b2c3d4e5f6a7b8c9d03"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d02"),
    type: "violation_fine",
    termCode: null,
    description: "Phat vi pham gio gioi nghiem ngay 10/02/2025",
    amount: 200000,
    paidAmount: 0,
    dueDate: new Date("2025-03-10T23:59:59.000Z"),
    status: "unpaid",
    relatedRequestId: null,
    createdBy: id("665a1b2c3d4e5f6a7b8c9d02"),
    createdAt: new Date("2025-02-11T08:00:00.000Z"),
    updatedAt: new Date("2025-02-11T08:00:00.000Z"),
  },
  {
    _id: id("66621b2c3d4e5f6a7b8c9d06"),
    invoiceCode: "INV-2025-0006",
    studentId: id("665b1b2c3d4e5f6a7b8c9d01"),
    roomId: id("665d1b2c3d4e5f6a7b8c9d01"),
    type: "damage_compensation",
    termCode: null,
    description: "Boi thuong ghe bi gay chan trong phong A101",
    amount: 400000,
    paidAmount: 0,
    dueDate: new Date("2025-03-15T23:59:59.000Z"),
    status: "unpaid",
    relatedRequestId: null,
    createdBy: id("665a1b2c3d4e5f6a7b8c9d01"),
...
const paymentsData = [
  {
    ...
    invoiceId: id("66621b2c3d4e5f6a7b8c9d01"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d01"),
    amount: 3600000,
    paymentMethod: "bank_transfer",
    transactionCode: "VCB20250210143000001",
    note: "Chuyen khoan Vietcombank",
    paidAt: new Date("2025-02-10T14:30:00.000Z"),
    createdAt: new Date("2025-02-10T14:30:00.000Z"),
  },
  {
    _id: id("66631b2c3d4e5f6a7b8c9d02"),
    invoiceId: id("66621b2c3d4e5f6a7b8c9d03"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d03"),
    amount: 1800000,
    paymentMethod: "e_wallet",
    transactionCode: "MOMO20250215100000001",
    note: "Thanh toan 1 nua qua Momo",
    paidAt: new Date("2025-02-15T10:00:00.000Z"),
    createdAt: new Date("2025-02-15T10:00:00.000Z"),
  },
  {
    _id: id("66631b2c3d4e5f6a7b8c9d03"),
    invoiceId: id("66621b2c3d4e5f6a7b8c9d04"),
    studentId: id("665b1b2c3d4e5f6a7b8c9d04"),
    amount: 3600000,
    paymentMethod: "cash",
    transactionCode: "CASH20250205110000001",
    note: "Nop tien mat tai van phong",
    paidAt: new Date("2025-02-05T11:00:00.000Z"),
...
const notificationsData = [
  {
    ...
    receiverIds: [
      id("665a1b2c3d4e5f6a7b8c9d04"),
      id("665a1b2c3d4e5f6a7b8c9d05"),
      id("665a1b2c3d4e5f6a7b8c9d06"),
      id("665a1b2c3d4e5f6a7b8c9d07"),
    ...
    readBy: [
      {
        userId: id("665a1b2c3d4e5f6a7b8c9d04"),
        readAt: new Date("2025-02-02T08:30:00.000Z"),
      },
      {
        userId: id("665a1b2c3d4e5f6a7b8c9d07"),
        readAt: new Date("2025-02-02T09:15:00.000Z"),
      },
    ],
...
const settingsData = [
  {
    _id: id("66651b2c3d4e5f6a7b8c9d01"),
    key: "electricity_excess_price",
    value: 3500,
    description: "Gia dien vuot muc cho phep (VND/kWh)",
    updatedBy: id("665a1b2c3d4e5f6a7b8c9d01"),
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
  {
    _id: id("66651b2c3d4e5f6a7b8c9d02"),
    key: "electricity_free_limit",
    value: 50,
    description: "So kWh dien mien phi moi phong moi thang",
    updatedBy: id("665a1b2c3d4e5f6a7b8c9d01"),
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
  {
    _id: id("66651b2c3d4e5f6a7b8c9d03"),
    key: "damage_compensation_rates",
    value: {
      fan: 500000,
      bed: 1000000,
      desk: 800000,
      ...
      door: 1500000,
      window: 1200000,
      air_conditioner: 5000000,
      water_heater: 3000000,
    },
    description: "Bang gia boi thuong thiet hai (VND)",
    updatedBy: id("665a1b2c3d4e5f6a7b8c9d01"),
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
  {
    _id: id("66651b2c3d4e5f6a7b8c9d04"),
    key: "term_duration_months",
    value: 4,
    description: "So thang moi ky thanh toan tien phong",
    updatedBy: id("665a1b2c3d4e5f6a7b8c9d01"),
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
  {
    _id: id("66651b2c3d4e5f6a7b8c9d05"),
    key: "late_payment_penalty_rate",
    value: 0.05,
    description: "Ty le phat khi thanh toan tre han (5%)",
    updatedBy: id("665a1b2c3d4e5f6a7b8c9d01"),
    createdAt: new Date("2025-01-01T00:00:00.000Z"),
    updatedAt: new Date("2025-01-01T00:00:00.000Z"),
  },
...
const violationRecordsData = [
  {
    ...
    roomId: id("665d1b2c3d4e5f6a7b8c9d02"),
    type: "curfew",
    description: "Sinh vien Le Van C ve phong luc 23h45, qua gio gioi nghiem.",
    fineAmount: 200000,
    invoiceId: id("66621b2c3d4e5f6a7b8c9d05"),
    reportedBy: id("665a1b2c3d4e5f6a7b8c9d02"),
    evidence: [],
    status: "invoiced",
    createdAt: new Date("2025-02-10T23:50:00.000Z"),
    updatedAt: new Date("2025-02-11T08:00:00.000Z"),
  },
];
...
async function seed() {
  try {
    ...
    await RoomAssignment.insertMany(roomAssignmentsData);
    console.log("   ✔ RoomAssignments: 5");
    await RoomRegistration.insertMany(roomRegistrationsData);
    console.log("   ✔ RoomRegistrations: 2");
    ...
    await ViolationRecord.insertMany(violationRecordsData);
    console.log("   ✔ ViolationRecords: 1");
    await ElectricityUsage.insertMany(electricityUsageData);
    console.log("   ✔ ElectricityUsage: 3");
